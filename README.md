...
- 📝 **Логирование**: Декораторы для автоматического логирования выполнения функций
...
test_poetry/
├── data/
│   └── operations.json           # Финансовые транзакции
├── src/                          # Исходный код
...
│   ├── decorators.py             # Тесты декораторов для логирования и мониторинга
...
Автоматическое логирование выполнения функций с поддержкой записи в файл и консоль:

```python
from src.decorators import log

@log(filename="operations.log")
def process_transaction(amount: float, account: str) -> bool:
...
- **100+ тестов** с полным покрытием функциональности
...
- **`test_decorators.py`** - Тестирование декораторов логирования
  - Логирование успешных операций
  - Логирование ошибок
  - Запись в файл и вывод в консоль
  - Сохранение метаданных функций

- **`test_utils.py`** - Тесты загрузки файлов
  - Валидные JSON-файлы
  - Пустые файлы и файлы с ошибками
  - Обработка отсутствующих файлов

- **`test_external_api.py`** - Тесты конвертации валют
  - Мокирование внешних API-запросов
  - Обработка успешных и неудачных конвертаций
  - Тесты с различными валютами
