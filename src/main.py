...
def main() -> None:
    print(
        "Добро пожаловать! Эта программа поможет вам маскировать номера карт и счетов, а также работать с датами и "
        "транзакциями."
    )
    ...
    info_string_account = input(
        "Введите строку с информацией о счете (например: 'счет 1234 56** **** 7890'): "
    ).strip()
